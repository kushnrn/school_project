...
<h1 style="text-align: center; margin-top:250px; font-size:64px;">
    Вхід в систему для завуча:
</h1>

<form action="" method="POST" style="width: 32%; margin: 30px auto;">
    <div class="form-group">
        <input type="number" class="form-control" placeholder="Введіть ваш айди" name="id" required>
    </div>
    ...
    <div class="input-group mb-3">
        ...
        <div class="input-group-append">
            <button type="submit" class="btn btn-outline-danger w-100" name="login">Вхід</button>
        </div>
    </div>
    <?php require_once 'employeeLoginServer.php' ?>
</form>
</body>
